...
# 13. Edit "latif-private-rt" route table:
...
# 19. Create new database named "latifdb".
CREATE DATABASE latifdb;

# 20. Create a user named "admin".
CREATE USER admin IDENTIFIED BY '123456789';

# 21. Grant permissions to the user "admin" for database "latifdb".
GRANT ALL ON latifdb.* TO admin IDENTIFIED BY '123456789' WITH GRANT OPTION;  
...
# 4. Select Subnet associations sub-menu ---> Edit subnet association ---> select "latif-az1a-private-subnet" ---> edit
...
# 6. Go to the NACL named "latif-private1a-nacl"
...
# 10. Go to the NACL named "latif-private1a-nacl"
